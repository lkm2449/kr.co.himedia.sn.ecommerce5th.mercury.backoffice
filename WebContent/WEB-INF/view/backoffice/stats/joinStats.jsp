...
<head>
	...
	<script>
		function selectyear(){
			...
			frmMain.method="POST";
			frmMain.action="/backoffice/stats/joinStats.web";
	...
	<div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">가입 통계</h1>
					</div><!-- /.col -->
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="#">통계 분석</a></li>
							<li class="breadcrumb-item">가입 통계</li>
						</ol>
					</div><!-- /.col -->
				</div><!-- /.row -->
			</div><!-- /.container-fluid -->
								...
								<div class="card-tools">
									<select name="year" onchange="selectyear()">
										<c:forEach items="${year}" var="year">
											<option value="${year }" <c:if test="${myYear == year}"> selected</c:if>>${year }년</option>
										</c:forEach>
									</select>
									...
									<tbody>
										<c:choose>
											<c:when test="${empty list}">
												<tr>
													<td colspan="3" style="text-align: center;">가입한 회원이 없습니다.</td>
												</tr>
											</c:when>
											<c:otherwise>
