...
<head>
	...
	<script>
		function goPage(value) {
			...
			frmMain.action = "/backoffice/board/inquiryList.web";
			frmMain.submit();
		}
	</script>
</head>
...
<div class="wrapper">
	...
	<form id="frmMain" method="POST" action="/backoffice/board/inquiryList.web">
											...
											<c:forEach items="${list}" var="list">
												<tr>
													...
													<td style="text-align: left">
														<a href="/backoffice/board/inquiryView.web?seq_bbs=${list.seq_bbs}">
