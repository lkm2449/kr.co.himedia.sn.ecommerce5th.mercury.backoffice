...
<head>
	...
	<script>
		...
		frmMain.action = "/backoffice/board/faqList.web";
		frmMain.submit();
	}
	</script>
</head>
...
<div class="wrapper">
	...
	<form id="frmMain" method="POST" action="/backoffice/board/faqList.web">
						...
						<div class="card">
							...
							<div class="card-body table-responsive p-0">
											...
											<c:forEach items="${list}" var="list">
												<tr>
													...
													<td style="text-align: left">
														<a href="/backoffice/board/faqView.web?seq_bbs=${list.seq_bbs}">
								...
								<div style="text-align:center">
									...
									<br />
									<a href="/backoffice/board/faqWriteForm.web?cd_bbs_type=2" class="btnBasic"> 등록 </a>
								</div>
							</div>
							<!-- /.card-body -->
						</div>
